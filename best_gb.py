...
class BestGB:
    ...
    def find_n_estimators(self, max_value, n_of_values):
        ...
        for n in np.linspace((max_value//n_of_values), max_value, n_of_values):
            n_estimator_rf = GradientBoostingRegressor(n_estimators=int(n), max_features='sqrt', random_state=42)
    ...
    def find_max_depth(self, max_value, n_of_values):
        max_depth = {}
        for n in np.linspace((max_value//n_of_values), max_value, n_of_values):
            max_depth_rf = GradientBoostingRegressor(max_depth=int(n), max_features='sqrt', random_state=42)
    ...
    def find_min_sample_split(self, max_value, n_of_values):
        min_sample_split = {}
        for n in np.linspace((max_value//n_of_values), max_value, n_of_values):
            min_sample_split_rf = GradientBoostingRegressor(min_samples_split=int(n), max_features='sqrt', random_state=42)
    ...
    def find_min_samples_leaf(self, max_value, n_of_values):
        min_samples_leaf = {}
        for n in np.linspace((max_value//n_of_values), max_value, n_of_values):
            min_samples_leaf_rf = GradientBoostingRegressor(min_samples_leaf=int(n), max_features='sqrt', random_state=42)
